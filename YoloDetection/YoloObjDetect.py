...
# 	help="Thepopecode\image")
#args = vars(ap.parse_args())
ap.add_argument("-y", "--yolo", required=True,
	help="ClimateTest\Thepopecode\yolo")
#args = vars(ap.parse_args())
...
# load our input img and grab its spatial dimensions
image = cv2.imread(r'C:\Users\User\PycharmProjects\ClimateTest\Thepopecode\img\output-onlinepngtools.png')
